...
function importAsset() {
  ...
  if [[ $assetType = referenceData* ]]; then
	...
	cd ${HOME_DIR}
    DIR="./assets/projectConfigs/${repoName}/referenceData/"
    if [ -d "$DIR" ]; then
        ...
        cd ./assets/projectConfigs/${repoName}/referenceData/
...
function projectParameters(){
 # Importing Project Parameters
  ...
  cd ${HOME_DIR} ## SG added
  DIR="./assets/projectConfigs/${repoName}/parameters/" # SG added 
  if [ -d "$DIR" ]; then
      echo "Project Parameters needs to be synched"
      #cd ./assets/projectConfigs/parameters/
	  cd ./assets/projectConfigs/${repoName}/parameters/
